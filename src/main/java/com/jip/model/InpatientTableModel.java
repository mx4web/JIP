 ...
 * @author Yu Xiao
 */
public class InpatientTableModel extends AbstractTableModel {

    private final Logger logger = LoggerFactory.getLogger(this.getClass().getName());
    private ArrayList<InpatientData> data = new ArrayList<>();
    private ArrayList<String> columnNames = new ArrayList<>();

    /**
     * Constructor
     */
    public InpatientTableModel() {
        super();
        logger.info("InpatientTableModel instantiated");
    }
    ...
    public int loadData(ResultSet resultSet) {
        ...
        try {
            while (resultSet.next()) {
                //logger.debug("loadData: in do/while");
                rowCount++;
                ...
                data.add(ipd);
                //System.out.println(rowCount + ipd.toString());
            }
        } catch (SQLException e) {
...
//        this.fireTableDataChanged();
     ...
     * @return
     */
    public InpatientData getInpatientData(int row) {
        return data.get(row);
    }
    ...
    public Object getValueAt(int row, int col) {
        switch (col) {
            ...
            case 6:
                return data.get(row).getServices();
        }
        return null;
    }
    ...
    public void setValueAt(Object value, int row, int col) {
        ...
        switch (col) {
            ...
            case 5:
                ...
                break;
            case 6:
                data.get(row).setServices((BigDecimal) value);
                break;
        }
